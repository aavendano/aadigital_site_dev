...
## **2\. Full Folder Structure (Monorepo)**

/  
├── backend/ \# Strapi Headless CMS  
│ ├── package.json  
│ ├── src/  
│ │ ├── api/ \# Strapi Controllers & Schemas  
│ │ └── admin/ \# Admin Panel customizations  
│ └── config/  
├── frontend/ \# Astro & Starlight Hybrid Output  
│ ├── astro.config.mjs \# Core configuration (Astro \+ Starlight)  
│ ├── package.json  
│ ├── tsconfig.json  
│ ├── public/  
│ │ ├── robots.txt \# Crawler directives  
│ │ ├── favicon.svg \# Official logo  
...
### **frontend/astro.config.mjs (Astro & Starlight Integration)**
...
const SITE_URL \= '\[https://aadigitalbusiness.com\](https://aadigitalbusiness.com)';
...
### **frontend/src/content/config.ts (Zod Schemas)**
...
### **frontend/src/components/SEO/JsonLd.astro**
...
### **frontend/src/pages/blog/\[slug\].astro (Hybrid SSG Fetching Example)**
...
### **frontend/src/content/docs/index.mdx**
...
- **Environment Variables:** Must include STRAPI_URL and STRAPI_API_TOKEN in Cloudflare settings to allow SSG fetching.
...
_Engineered by AA Digital Business._
